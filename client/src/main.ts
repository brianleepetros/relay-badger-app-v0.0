...
const tipForm: HTMLFormElement = document.getElementById("tip-form") as HTMLFormElement;
const tipInput: HTMLFormElement = document.getElementById("tipText") as HTMLFormElement;
const usernameInput: HTMLFormElement = document.getElementById("tipUsername") as HTMLFormElement;
...
const handleFormSubmit = (e: any) => {
    ...
    const newTip = {
        ...
        topic: "user-post-relay-badger-app-v0.0",
        tip: tipContent,
    };
